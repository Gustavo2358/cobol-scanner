...
public final class Options {
  ...
  public final List<Path> copyDirs = new ArrayList<>(),
      sqlDirs = new ArrayList<>(),
      dclgenDirs = new ArrayList<>();
  ...
  public long sourceBudget() {
    return maxSourceBytes > 0 ? maxSourceBytes : Runtime.getRuntime().maxMemory() / (24L * threads);
  }
  ...
  public static Options parse(String... args) {
    ...
    if (!o.help && (o.source == null || o.output == null))
      throw new IllegalArgumentException("--source and --output required");
    if (!Set.of("fixed", "free").contains(o.format))
      throw new IllegalArgumentException("--source-format: fixed|free");
    if (o.threads < 1 || o.threads > 64) throw new IllegalArgumentException("--threads: 1..64");
    if (o.maxSourceBytes < 0
        || o.maxCandidates < 1
        || o.maxValueChars < 1
        || o.maxIncludeDepth < 1
        || o.maxIncludeDepth > 256)
      throw new IllegalArgumentException("Invalid resource budget (include depth 1..256)");
    return o;
  }
}
