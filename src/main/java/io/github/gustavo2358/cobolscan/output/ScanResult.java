...
public final class ScanResult {
  ...
  public final SortedSet<String> programs = new TreeSet<>(),
      externalFileNames = new TreeSet<>(),
      tables = new TreeSet<>(),
      copybooks = new TreeSet<>(),
      sqlIncludes = new TreeSet<>(),
      dclgens = new TreeSet<>();
  ...
  public void partial(String message) {
    ...
    if (!scanStatus.equals("ERROR")) scanStatus = "PARTIAL";
  }
}
